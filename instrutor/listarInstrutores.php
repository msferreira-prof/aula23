...
<comment>teste </comment>
    ...
    $comandoSQL = "select id, rg, nome, dataNascimento, ddd, telefone, titulos.descricao as titularidade
                   from instrutores inner join titulos
                   on instrutores.codigoTitulo = titulos.codigo;";
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light px-0">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="mynavbar">
                <div class="navbar-nav">
                    ...
                    <a href="cadastroInstrutor.php" class="nav-link">Cadastrar</a>
            ...
            <table class="table
                ...
                <?php 
                    while ( $linha = mysqli_fetch_array($resultadoConsulta) ) {
                        ...
                        $dataNascimentoFormatada = date("d/m/Y", $timestamp);
